...
a = cb.CubieCube()
# twist < 2187 in phase 1, twist = 0 in phase 2

# twist: 3^7 = 2187 possible orientations of the 8 corners
fname = "move_twist"
...
fh.close()
# -----------------------------------------------
# ################  Move table for the flip of the edges. flip < 2048 in p

# The flip coordinate describes the 2^11 = 2048 possible orientations of
# the 12 edges
fname = "move_flip"
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
# ###################### Move table for the four UD-slice edges FR, FL, Bl
...
# slice_sorted  < 11880 in phase 1, slice  < 24 in phase 2, slice = 0 for
# solved cube
...
# ################# Move table for the u_edges coordinate for transition p
...
# ################# Move table for the d_edges coordinate for transition p
...
# ######################### # Move table for the edges in the U-face and D

# The ud_edges coordinate describes the 40320 permutations of the edges
# UR, UF, UL, UB, DR, DF, DL and DB in phase 2
fname = "move_ud_edges"
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
# ############################ Move table for the  corners coordinate in p
